...
export function ProjectCard({ nome, description, url, link,hover_desc }: ProductProps) {
  return (
    <div title={hover_desc} className="max-w-sm rounded overflow-hidden shadow-lg bg-black p-4 m-4 border border-gray-200 transform transition duration-500 group">
